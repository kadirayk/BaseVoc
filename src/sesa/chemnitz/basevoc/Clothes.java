...
public class Clothes extends Activity{
	...
	String englishWords[]={"hat", "dress", "skirt", "shirt", "t-shirt", "pants", "shoes", "pocket"};
	String turkishWords[]={"þapka", "elbise", "etek", "gömlek", "tiþört", "pantolon", "ayakkabý", "cep"};
	String germanWords[]={"hut", "kleiden", "rock", "hemd", "t-shirt", "hose", "schuhe", "tasche"};
		...
		studyButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(holder!=-1){
					...
					word.setText(R.string.s_hat+holder);
				}
