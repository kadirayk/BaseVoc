...
public class Math extends Activity{
	...
	String englishWords[]={"meter", "centimeter", "kilogram", "half", "circle", "square", "plus", "minus"};
	String turkishWords[]={"metre", "santimetre", "kilogram", "yarý", "daire", "kare", "artý", "eksi"};
	String germanWords[]={"meter", "zentimeter", "kilogramm", "hälfte", "kreis", "quadrat", "plus", "minus"};
		...
		studyButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(holder!=-1){
					...
					word.setText(R.string.s_meter+holder);
				}
