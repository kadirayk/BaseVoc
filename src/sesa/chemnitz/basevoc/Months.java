...
public class Months extends Activity{
	...
	String turkishWords[]={"ocak", "þubat", "mart", "nisan", "mayýs", "haziran", "temmuz", "aðustos", "eylül", "ekim", "kasým", "aralýk"};
	String germanWords[]={"januar", "februar", "märz", "april", "mai", "juni", "juli", "august", "zebtember", "oktober", "november", "dezember"};
