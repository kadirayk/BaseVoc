...
public class Animals extends Activity{
	...
	String englishWords[]={"Animal", "dog", "cat", "fish", "bird", "snake", "cow", "pig", 
			"mouse", "horse", "elephant", "tail", "wing"};
	String turkishWords[]={"Hayvan", "köpek", "kedi", "balýk", "kuþ", "yýlan", "inek", "domuz",
			"fare", "at", "fil", "kuyruk", "kanat"};
	String germanWords[]={"Tiere", "hunt", "katze", "fisch", "vogel", "schlange", "kuh", "schwein",
			"maus", "pferd", "elefant", "schwanz", "flügel"};
		...
		studyButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(holder!=-1){
					...
					word.setText(R.string.s_animals+holder);
				}
