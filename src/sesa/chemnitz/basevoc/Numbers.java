...
public class Numbers extends Activity{
	...
	String englishWords[]={"first", "second", "third", "fourth", "fifth", "sixth", "seventh", "eigth", "ninth", "tenth"};
	String turkishWords[]={"birinci", "ikinci", "üçüncü", "dördüncü", "beþinci", "altýncý", "yedinci", "sekizinci", "dokuzuncu", "onuncu"};
	String germanWords[]={"erste", "zweite", "dritte", "vierte", "fünfte", "sechste", "siebte", "achte", "neunte", "zehntel"};
		...
		studyButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(holder!=-1){
					...
					word.setText(R.string.s_first+holder);
				}
