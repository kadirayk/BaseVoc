...
public class Menutr extends ListActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<String>(Menutr.this, R.layout.listen, classes));
    }
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try{
			...
			Intent anIntent = new Intent(Menutr.this, aClass);
			anIntent.putExtra("callertr", true);
