...
public class AdjectivesAdverbs extends Activity{
	...
	String turkishWords[]={"uzun/kýsa", "uzun boylu/kýsa boylu", "geniþ/dar", "büyük/küçük", "yavaþ/hýzlý", 
			"sýcak/soðuk", "yeni/eski", "iyi/kötü", "ýslak/kuru", "hasta/saðlýklý", "gürültülü/sessiz", "mutlu/üzgün", 
			"güzel/çirkin", "hoþ/sevimsiz", "zengin/fakir", "kalýn/ince", "pahalý/ucuz", "düz/kavisli", 
			"erkek/diþi", "sýký/gevþek"};
	String germanWords[]={"lange/kurz", "groß/kurz", "breit/schmal", "groß/klein", "langsam/schnell", 
			"heiß/kalt", "neu/alt", "gut/schlect", "nass/trocknen", "krank/gesunt", "laut/ruhig", "glücklich/traurig", 
			"schön/hässlich", "schön/mittlere", "reich/arm", "dick/dünn", "teuer/billig", "flach/gewölbt", 
			"männlich/weiblich", "eng/lose"};
