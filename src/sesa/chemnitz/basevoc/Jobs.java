...
public class Jobs extends Activity{
	...
	String turkishWords[]={"öðretmen", "doktor", "garson", "sekreter", "rahip", "patron", "maaþ", "gelir", "gider"};
	String germanWords[]={"lehrer", "arzt", "kellner", "sekretär", "priester", "chef", "gehalt", "einkommen", "ausgabe"};
